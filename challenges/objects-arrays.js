...
const uni = graduates.filter(school => school.university.includes("Uni"));
console.log(uni);
...
The zoos need a list of all their animal's names (names only, not scientific) converted to lower case.  Create a new array named lowerCase and map over 
...
console.log('All array method callbacks have been converted into arrow function'); // Stretch goal completed
